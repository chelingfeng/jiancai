...
$(function () { 
     ...
     $(document).on("pageInit", "#graduation-search", function(e, id, page) { 
       ...
       cmdbed = document.getElementById('bed');
        ...
        function addback(v)
        {
            ...
            window.history.pushState(json,"",hqb.root+"/index.php?m=Apartment&c=Swap&a=index&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode+"#"+v); 
        }
        ...
        $(page).on('click','.home',function(){
            $.router.load(hqb.root+"/index.php?m=Apartment&c=Swap&a=index&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode+"#1", true); 
        });
        ...
        $(page).on('click','.btn_cancel',function (){
            ...
            $.confirm('确认要取调宿消申请吗?', function () { 
                $.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=change_batchcheck", 
                {
        ...
        $(page).on('click','.btn_quitcancel',function(){
            ...
            var id = $('#quitapply_id').val();
             ...
             $.confirm('确认要取消退宿申请吗?', function () {
                    $.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=quit_checkoutroom", 
                    {
        ...
        {
            $.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=get_detail_bykey", 
                {
                    changeid:id,              
                }, function(res) 
                {
        ...
        {
            $.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=getoutrecordlist", 
                {
                    outroomid:id,              
                }, function(res) 
                {
     	...
     	$(page).on('click','.btn_change',function(){
     		...
     		$.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=add_change", 
	     	{
	     	    schoolcode:schoolcode,studentnumber:studentnumber,oldbedid:oldbedid,newbedid:newbedid,createbyid:createbyid,createrol:createrol,memo:memo,   
	        }, function(res) 
	        {
                console.log(res);
	        	if (res.code == 0) 
	        	{
	        		$.router.load(hqb.root+"/index.php?m=Apartment&c=Swap&a=Jump&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode, true);
		...
		$(page).on('click','.btn_quit',function(){ 
     		...
     		$.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=addoutroom", 
	     	{
     	...
     	$(page).on('change','#flat',function(){
     		...
     		var flatid = $(this).val();
     		$.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=get_empty_bedlist",  //根据楼栋ID 获取空寝室和 床位
	     	{
     ...
     function Isbinding()
     {
        ...
        { 
            if(res.code == 40013)
            {            	 
            	 $.router.load(hqb.root+"/index.php?m=Apartment&c=Swap&a=Studentbinding&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode, true);
            ...
            else
            {
            	...
            	{  
	            	...
	            	$.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=getFloorList",
	            	{
	            	...
	            	},function (data)
	            	{
	                     ...
	                     {                          
                          ...
                          studentkey =hqb.schoolcode +"_"+ res.data.studentNumber;
                            ...
                            $.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=get_applylist_bykey", 
                            {
     ...
     $(document).on("pageInit", "#Student_binding", function(e, id, page) { 
			...
			$(page).on('click','.button-bind',function(){
		     		...
		     		var studentNumber = $('#studentNumber').val();
		     		$.post(hqb.root+"/index.php?m=Apartment&c=Swap&a=bindmessage", {
                    ...
                    {
                    	$.alert(res.msg);
                    	$.router.load(hqb.root+"/index.php?m=Apartment&c=Swap&a=index&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode, true);
    ...
    $(document).on("pageInit", "#page-success", function(e, id, page) { 
       setInterval(function(){   
           $.router.load(hqb.root+"/index.php?m=Apartment&c=Swap&a=index&openid="+hqb.openid+"&schoolcode="+hqb.schoolcode+"#3", true); 
       },2000); 
