...
<div id="think_page_trace_tab_tit" style="height:38px;padding: 6px 12px 0;border-bottom:1px solid #ececec;border-top:1px solid #ececec;font-size:16px;">
